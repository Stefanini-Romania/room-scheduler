...
(function (a) {
    ...
    a.extend(a.jqx._jqxScheduler.prototype, {
        defineInstance: function () {
            ...
            var c = b.find("button");
            c.jqxButton({theme: d.theme, width: "50%", height: 30});
            var e = false;
            ...
            //console.log('localizestrings', b,c);
            ...
            c.jqxAppointment = n;
            n.jqxAppointment = n;
            g._raiseEvent("appointmentAdd", {appointment: n.boundAppointment});
            g.uiappointments.push(n);
            g.changedAppointments[v] = {type: "Add", appointment: n.boundAppointment};
            ...
            for (var aa = 0; aa < E.length; aa++) {
                ...
                a.each(ai.cells, function (p) {
                    ...
                    m[0].appointments.push({ui: Q, appointment: ai});
                    Q = Q;
                            ...
                            x[0].mousedown = function () {
                                ...
                                for (var aB = 0; aB < m[0].appointments.length; aB++) {
                                    ...
                                    az.click(function (aH) {
                                        ...
                                        Y._raiseEvent("appointmentClick", {appointment: aI.boundAppointment})
                                    });
                                    az.dblclick(function (aI) {
                                        ...
                                        Y._raiseEvent("appointmentDoubleClick", {appointment: aJ.boundAppointment})
                                    });
                                    aG += az.outerHeight() + 4;
                                    aE.append(az)
                                }
            ...
            if (e !== f) {
                //console.log("Prop changed", d, f, e);
                if (d == "filterable") {
                    b._render()
                } else {
                    if (d == "view") {
